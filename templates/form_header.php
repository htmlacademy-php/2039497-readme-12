<div class="adding-post__input-wrapper form__input-wrapper">
    ...
    <div class="form__input-section <?=get_class_error($errors, "$type_content-heading");?>">
        <input class="adding-post__input form__input" id="<?=$type_content;?>-heading" type="text" name="<?=$type_content;?>-heading" placeholder="Введите заголовок" value="<?=get_post_val("$type_content-heading");?>">
