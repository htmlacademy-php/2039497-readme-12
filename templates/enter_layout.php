        ...
        <section class="authorization">
          ...
          <form class="authorization__form form" action="#" method="post">
            <div class="authorization__input-wrapper form__input-wrapper">
              ...
              <?php endif;?>
              <input class="authorization__input authorization__input--login form__input" type="text" name="login" placeholder="Логин" value="<?=htmlspecialchars(get_post_val('login'));?>">
            ...
            <div class="authorization__input-wrapper form__input-wrapper">
              ...
              <div class="form__input-section form__input-section--error">
              <?php endif;?>
              <input class="authorization__input authorization__input--password form__input" type="password" name="password" placeholder="Пароль" value="<?=htmlspecialchars(get_post_val('password'));?>">
