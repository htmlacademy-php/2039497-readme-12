...
<div class="form__input-section <?=get_class_error($errors, "$type_content-tags");?>">
    <input class="adding-post__input form__input" id="<?=$type_content;?>-tags" type="text" name="<?=$type_content;?>-tags" placeholder="Введите теги" value="<?=get_post_val("$type_content-tags");?>">
